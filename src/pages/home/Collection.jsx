...
const Collection = () => {
    return (
        <div className='text-center mt-20 my-28 md:px-20 px-0'>
            ...
            <div className='grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5'>
                <div className='col-span-1 sm:order-1 order-2 bg-center bg-cover rounded-3xl flex justify-center relative h-96'
                  style={{
                ...
                <div className='md:col-span-2 sm:col-span-1 sm:order-2 order-1 bg-center bg-cover rounded-3xl flex justify-center items-center h-96'
                  style={{
